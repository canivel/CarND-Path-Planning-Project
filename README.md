...
Like I said, this is a very easy simple solution that don't take some value points in consideration, for example:
* we should look to the whole scenario, checking all the vehicles velocity around us, and calculate safe distances from all of them, based on the speed of them.
